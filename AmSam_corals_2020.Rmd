...
Similar to FastX Toolobox, we will use a similar program called Trimmomatic to both QC and pair raw reads. In the following example, I show how to run Trimmomatic on a single end (SE) file and paired end (PE) files. Our coral samples are 150 bp PE reads, so we will use the PE mode.
